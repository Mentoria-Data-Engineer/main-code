...
def load_users(ti, **kwargs) -> None:
    # Extrai a data do contexto
    execution_date = kwargs['execution_date']
    date_string = execution_date.strftime('%d-%m-%Y')
    
    # Monta o nome do arquivo com a data
    path = f'/home/nay/Downloads/engdados/github/main-code/data/processed/users-{date_string}.csv'
...
with DAG(
    ...
    #     op_kwargs={'path': '/home/nay/Downloads/engdados/github/main-code/data/users.csv'}
    # )
    # task_load_users = PythonOperator(
    #     task_id='load_users',
    #     python_callable=load_users
